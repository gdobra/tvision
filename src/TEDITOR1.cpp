...
int TEditor::charPos( ulong p, ulong target )
{
    ulong pos = 0;
    while( p < target )
    {
...
ulong TEditor::charPtr( ulong p, int target )
{
  ulong pos = 0;
...
void TEditor::deleteRange( ulong startPtr,
                           ulong endPtr,
                           Boolean delSelect
                         )
{
...
void TEditor::drawLines( int y, int count, ulong linePtr )
{
