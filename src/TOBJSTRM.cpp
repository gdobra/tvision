...
ipstream& operator >> (ipstream& ps, long long &ll)
{
    ps.readBytes(&ll, sizeof(ll));
    return ps;
}
...
opstream& opstream::seekp( streamoff pos, ios::seekdir dir )
{
    objs->removeAll();
...
opstream& operator << (opstream& ps, long long ll)
{
    ps.writeBytes( &ll, sizeof(ll) );
    return ps;
}
...
fpbase::fpbase( const char *name, ios::openmode omode, int prot )
{
    pstream::init( &buf );
...
fpbase::fpbase(char *b, int len ) : buf( )
{
    buf.pubsetbuf(b, len);
    pstream::init( &buf );
}
...
void fpbase::open( const char *b, ios::openmode m, int prot )
{
    if( buf.is_open() )
...
ifpstream::ifpstream( const char* name, ios::openmode omode, int prot ) :
...
ifpstream::ifpstream(char* b, int len) : fpbase(b, len)
{
}
...
void ifpstream::open( const char _FAR *name, ios::openmode omode, int prot )
{
...
ofpstream::ofpstream( const char* name, ios::openmode omode, int prot ) :
...
ofpstream::ofpstream(char* b, int len) : fpbase(b, len)
{
}
...
void ofpstream::open( const char _FAR *name, ios::openmode omode, int prot )
{
...
fpstream::fpstream( const char* name, ios::openmode omode, int prot ) :
        fpbase( name, omode | ios::out | ios::binary, prot )
{
}
...
fpstream::fpstream(char* b, int len) : fpbase(b, len)
{
}
...
void fpstream::open( const char _FAR *name, ios::openmode omode, int prot )
{
