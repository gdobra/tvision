...
//  bug-fix TV2B-31 ---------------------------------------
    "General failure on drive %c",                  // C  - EFW - CHANGED
    "Sharing violation on drive %c",                // D  - EFW - CHANGED
    "Lock violation on drive %c",                   // E  - EFW - CHANGED
    "Disk change invalid on drive %c",              // F  - EFW - ADDED
    "FCB unavailable",                              //10h - EFW - ADDED
    "Sharing buffer overflow",                      //11h - EFW - ADDED
    "Code page mismatch",                           //12h - EFW - ADDED
    "Out of input",                                 //13h - EFW - ADDED
    "Insufficient disk space on drive %c",          //14h - EFW - ADDED

    "Insert diskette in drive %c"                   //15h - EFW - CHANGED
//  end of bug-fix. ---------------------------------------
};
